...
#ifdef LEVELS
         subroutine Recombination_ReadParams(R)
          use IniFile
          Type(RecombinationParams) :: R

             R%RECFAST_fudge_He = Ini_Read_Double('RECFAST_fudge_He',RECFAST_fudge_He_default)
             R%RECFAST_Heswitch = Ini_Read_Int('RECFAST_Heswitch',RECFAST_Heswitch_default)
             R%RECFAST_Hswitch = Ini_Read_Logical('RECFAST_Hswitch',RECFAST_Hswitch_default)
             R%RECFAST_fudge = Ini_Read_Double('RECFAST_fudge',RECFAST_fudge_default)
             AGauss1 = Ini_REad_Double('AGauss1',AGauss1)
             AGauss2 = Ini_REad_Double('AGauss2',AGauss2)
             zGauss1 = Ini_REad_Double('zGauss1',zGauss1)
             zGauss2 = Ini_REad_Double('zGauss2',zGauss2)
             wGauss1 = Ini_REad_Double('wGauss1',wGauss1)
             wGauss2 = Ini_REad_Double('wGauss2',wGauss2)
