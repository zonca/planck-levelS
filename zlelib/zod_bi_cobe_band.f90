...
!
!-----------------------------------------------------------------------------
MODULE ZOD_BI_COBE_BAND
!
! ZOD_BI_COBE_BAND 0.0 By M. Maris - 12 Jul 2004 - 23 Aug 2004 -
!
! Class to handle the Brightness Integral for COBE BAND
!
...
!    File renamed to ZOD_BI_COBE_BAND from ZOD_BRINT_COBE_BAND
...
Character(len=*), Parameter :: ZOD_BI_COBE_BAND_VERSION = 'ZOD_BI_COBE_BAND 0.0 By M. Maris - 12 Jul 2004 - '
...
Double Precision function P_FX_COBE_BAND_DENSITY(Distance)
!
...
! local variables
    ...
    d=ZOD_density_COBE_BAND(HPos,P_MY_DensDstr_COBE_BAND)

    P_FX_COBE_BAND_DENSITY = d
End Function P_FX_COBE_BAND_DENSITY

Double Precision function P_FX_COBE_BAND_DENS(Distance)
!
! for an heliocentric DISTANCE in AU computes the local 3D optical density
...
! Parameters are passed through Private Members
!
! The BB is in cgs units and it is assumed Lambda=1cm
!
USE ZOD_BI_BASE
...
!print*,bb_rj
    ...
    P_FX_COBE_BAND_DENS = d*bb_rj
End Function P_FX_COBE_BAND_DENS

Double Precision function P_FX_COBE_BAND_DENS_TN(Distance)
!
! for an heliocentric DISTANCE in AU computes the local 3D optical density
...
bb_rj = bb_rj*ScaleToMJ
    ...
    P_FX_COBE_BAND_DENS_TN = d*bb_rj*TN
End Function P_FX_COBE_BAND_DENS_TN

Double Precision function P_FX_COBE_T_BAND_DENS(Distance)
!
! for an heliocentric DISTANCE in AU computes the local 3D optical density
! scaled by T
!
...
! local variables
    ...
    P_FX_COBE_T_BAND_DENS = d*TR
End Function P_FX_COBE_T_BAND_DENS

END MODULE ZOD_BI_COBE_BAND
