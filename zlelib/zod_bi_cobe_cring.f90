...
!
!-----------------------------------------------------------------------------
MODULE ZOD_BI_COBE_CRING
!
! ZOD_BI_COBE_CRING 0.1 By M. Maris - 12 Jul 2004 - 23 Aug 2004 -
!
! Class to handle the Brightness Integral for COBE CRING
!
...
!    File renamed to ZOD_BI_COBE_CRING from ZOD_BRINT_COBE_CRING
!
...
Character(len=*), Parameter :: ZOD_BI_COBE_CRING_VERSION = 'ZOD_BI_COBE_CRING 0.1 By M. Maris - 12 Jul 2004 - 23 Aug 2004 -'
...
Double Precision function P_FX_COBE_CRING_DENSITY(Distance)
!
...
! local variables
    ...
    d=ZOD_density_COBE_CRING(HPos,P_MY_DensDstr_COBE_CRING)

    P_FX_COBE_CRING_DENSITY = d
End Function P_FX_COBE_CRING_DENSITY

Double Precision function P_FX_COBE_CRING_DENS(Distance)
!
! for an heliocentric DISTANCE in AU computes the local 3D optical density
...
!print*,bb_rj
    ...
    P_FX_COBE_CRING_DENS = d*bb_rj
End Function P_FX_COBE_CRING_DENS

Double Precision function P_FX_COBE_CRING_DENS_TN(Distance)
!
! for an heliocentric DISTANCE in AU computes the local 3D optical density
...
bb_rj = bb_rj*ScaleToMJ
    ...
    P_FX_COBE_CRING_DENS_TN = d*bb_rj*TN
End Function P_FX_COBE_CRING_DENS_TN

Double Precision function P_FX_COBE_T_CRING_DENS(Distance)
!
! for an heliocentric DISTANCE in AU computes the local 3D optical density
! scaled by T
!
...
! local variables
    ...
    P_FX_COBE_T_CRING_DENS = d*TR
End Function P_FX_COBE_T_CRING_DENS


END MODULE ZOD_BI_COBE_CRING
