...
int map2tga_module (int argc, const char **argv)
  ...
  module_startup ("map2tga",argc>=2,
    ...
    "  map2tga <init object>\n\n"
    "or:\n"
    "  map2tga <input file> <output file> [-sig <string>] [-pal <int>]\n"
  ...
  read_Healpix_map_from_dmc(infile,map,signal,false);
